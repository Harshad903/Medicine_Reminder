...
import 'package:medcare3/pages/medicine_details/medicine_details.dart';
import 'package:medcare3/pages/new_entry/new_entry_page.dart';
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            '(BB:BeforeBreakfast, AB:AfterBreakfast, BL:BeforeLunch, AL:AfterLunch, BD:BeforeDinner, AD:AfterDinner)',
